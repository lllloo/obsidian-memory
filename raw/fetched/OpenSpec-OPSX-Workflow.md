---
title: OpenSpec OPSX Workflow
description: OpenSpec 官方 OPSX 工作流文件，涵蓋 actions-not-phases 設計、config.yaml 欄位、artifact DAG 引擎與自訂 schema
created: 2026-07-21
updated: 2026-07-21
source: https://github.com/Fission-AI/OpenSpec/blob/main/docs/opsx.md
published: ""
tags:
  - coding-agent
  - agent-framework
