...
description: Orca CLI 官方 skill 規格與參考文件，涵蓋 worktree、terminal、repo、browser、automations 與 artifacts 操作
created: 2026-09-24
updated: 2026-09-24
source:
published:
...
> 本檔取自本機 CLI（`orca-ide skills get orca-cli --full`），環境 appVersion 為 1.4.209。
