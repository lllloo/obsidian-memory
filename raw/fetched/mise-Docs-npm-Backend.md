---
title: "mise 官方文件：npm backend"
description: mise 以 npm: 前綴安裝全域 CLI 的機制；執行時使用當下環境的 Node，而非安裝時版本
created: 2026-09-24
updated: 2026-09-24
source: "https://mise.jdx.dev/dev-tools/backends/npm.html"
published: 
tags:
  - clippings
---
