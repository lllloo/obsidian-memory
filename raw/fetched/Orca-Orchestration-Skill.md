---
title: Orca Orchestration Skill
description: Orca 監督式多 agent 協調層 skill 規格，定義 Run、Task、Dispatch、supervised loop 與 worker contract
created: 2026-09-24
updated: 2026-09-24
source:
published:
...
> 本檔取自本機 CLI（`orca-ide skills get orchestration --full`），環境 appVersion 為 1.4.209。
