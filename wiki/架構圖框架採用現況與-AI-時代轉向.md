...
- [[架構視圖體系完整對照]] — 本頁答「業界實際上選了什麼」，該頁答「有哪些選項」（六套體系與 UML 官方分類的完整清單）。兩頁合看的實務意涵：**體系清單很長，但本頁的 ECSA 2024 計數顯示 96% 的真實視圖不遵循任何一套**——選框架不必當信仰問題。該頁另記一則本頁未涵蓋的版次事實：ISO/IEC/IEEE 42010 已於 2022-11-30 發布第二版，而其官網首頁仍寫 2011 為最新版。
