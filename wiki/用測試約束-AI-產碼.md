...
> 本頁與 [[AI-產碼加速下的-review-瓶頸]]、[[Uncle-Bob-的不讀碼約束閘門]] 的人讀合併版（長文＋八張圖）在 [`artifacts/ai-code-constraints.html`](../artifacts/ai-code-constraints.html)，單檔可直接用瀏覽器開；該頁是 2026-08-09 的快照，本頁維持完整密度與後續更新。
