...
- RAWGAP | `raw/fetched/OpenSpec-OPSX-Workflow.md` | 已消化——`wiki/OpenSpec.md` 第 23 行「2026-07-21 更新」段已依此檔重寫工作流／設定／schema 三節並回連;機械層仍 flag 因該 raw 檔本身未加 wikilink,同其他 fetched 檔慣例。2026-07-21 首見即結清
